...
class SupervisedTrainer(object):
    ...
    def train(
        ...
        epoch_time_step, trainset_list, validset = split_dataset(self.config, self.config.train.transcripts_path, self.vocab)
        if resume:
            ...
            self.trainset_list = trainset_list #resume_checkpoint.trainset_list
            self.validset = validset  #resume_checkpoint.validset
